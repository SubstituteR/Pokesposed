...
public class LocationManager {
    ...
    private static final float speed = 0.1389f; //0.2 meters/decisecond ~8 km/h


    public static void addLatLng(LatLng newLatLng)
    {
    ...
    public static void Update()
    {
        ...
        lastLatLng = FlatSettings.savedLatLng;
        NextLatLng();
        FlatSettings.savedLatLng = lastLatLng;
    }
...
//Rest is math...math is hard /-.-\
    ...
    private static boolean inDistance() //since we check this before updating, we can take the bearing value.
    {
        float[] d = {0,0};
